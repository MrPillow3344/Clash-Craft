...
public class ClashCraftModPotions {
	...
	public static final DeferredHolder<Potion, Potion> FREEZE = REGISTRY.register("freeze", () -> new Potion(new MobEffectInstance(ClashCraftModMobEffects.FREEZE_EFFECT, 80, 0, false, true)));
}
