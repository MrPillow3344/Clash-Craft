...
import net.mrpillow.clashcraft.potion.FreezeEffectMobEffect;
...
public class ClashCraftModMobEffects {
	...
	public static final DeferredHolder<MobEffect, MobEffect> FREEZE_EFFECT = REGISTRY.register("freeze_effect", () -> new FreezeEffectMobEffect());
}
