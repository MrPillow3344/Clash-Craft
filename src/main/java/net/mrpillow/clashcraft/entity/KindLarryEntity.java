...
public class KindLarryEntity extends TamableAnimal implements GeoEntity {
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		KindLarryEntity retval = ClashCraftModEntities.KIND_LARRY.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return List.of(ClashCraftModItems.LARRYS_BONE.get()).contains(stack.getItem());
	}
