...
public class KnightEntity extends TamableAnimal implements GeoEntity {
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, KindLarryEntity.class, false, false));
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		KnightEntity retval = ClashCraftModEntities.KNIGHT.get().create(serverWorld);
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(ClashCraftModEntities.KNIGHT.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(KnightEntity.RemovalReason.KILLED);
