...
public class FireballItemRightclickedProcedure {
	public static void execute(Entity entity) {
			...
			if (!projectileLevel.isClientSide()) {
				Projectile _entityToSpawn = new Object() {
					public Projectile getArrow(Level level, float damage, int knockback, byte piercing) {
						AbstractArrow entityToSpawn = new FireballProjectileEntity(ClashCraftModEntities.FIREBALL_PROJECTILE.get(), level) {
							@Override
		...
		if (entity instanceof Player _player) {
			ItemStack _stktoremove = new ItemStack(ClashCraftModItems.FIREBALL_ITEM.get());
