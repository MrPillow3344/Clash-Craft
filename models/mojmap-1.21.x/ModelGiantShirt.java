	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Shirt = partdefinition.addOrReplaceChild("Shirt",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, 0.0F, 2.05F, 8.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 12)
						.addBox(-4.0F, 0.0F, -2.05F, 8.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(16, 4)
						.addBox(4.05F, 0.0F, -2.0F, 0.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 20)
						.addBox(-4.05F, 0.0F, -2.0F, 0.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 0)
