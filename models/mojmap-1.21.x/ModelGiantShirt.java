...
public class ModelGiantShirt<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Shirt = partdefinition.addOrReplaceChild("Shirt", CubeListBuilder.create().texOffs(0, 0).addBox(
				-4.5F, 0.0F, -2.5F, 9.0F, 12.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
